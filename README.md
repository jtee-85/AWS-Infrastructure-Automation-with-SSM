...
1. Import Document: Copy the JSON from the /template folder.

2. Create SSM Document: In the AWS Console, go to Systems Manager > Documents > Create Automation.

3. Execute: Choose Execute Automation, select the document, and choose your Application (e.g., mariadb-server).

4. Verify: Once the status shows Success, use Session Manager to log in and run:
